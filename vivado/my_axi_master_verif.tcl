...
#
# my_axi_master_verif.tcl: Tcl script for re-creating project 'my_axi_master_verif'
#
# Generated by Vivado on Mon Feb 03 00:36:46 IST 2025
...
#
# 1. This project restoration tcl script (my_axi_master_verif.tcl) that was generated.
#
...
#
#    "/home/anubhav/Desktop/axi_ip/axi_ip_repo/vivado/axi_master_verif_top.sv"
#    "/home/anubhav/Desktop/axi_ip/axi_ip_repo/vivado/constraints.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/axi_master_verif_top.sv"]"\
...
set _xil_proj_name_ "my_axi_master_verif"
...
set script_file "my_axi_master_verif.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/my_axi_master_verif"]"
...
set file "$origin_dir/axi_master_verif_top.sv"
...
set_property -name "top" -value "axi_master_verif_top" -objects $obj
...
# Proc to create BD axi_verif_bd
proc cr_bd_axi_verif_bd { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name axi_verif_bd
  ...
  user.org:user:my_axi_master:1.0\
  ...
  # Create ports
  set start_write_txn [ create_bd_port -dir I start_write_txn ]
  set start_read_txn [ create_bd_port -dir I start_read_txn ]
  set write_base_addr [ create_bd_port -dir I -from 31 -to 0 write_base_addr ]
  set read_base_addr [ create_bd_port -dir I -from 31 -to 0 read_base_addr ]
  set write_data [ create_bd_port -dir I -from 511 -to 0 write_data ]
...
\
  ...
  set my_axi_master_0 [ create_bd_cell -type ip -vlnv user.org:user:my_axi_master:1.0 my_axi_master_0 ]
  ...
  connect_bd_intf_net -intf_net my_axi_master_0_m00_axi [get_bd_intf_pins my_axi_master_0/m00_axi] [get_bd_intf_pins axi_mem_intercon/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets my_axi_master_0_m00_axi] [get_bd_intf_pins my_axi_master_0/m00_axi] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins my_axi_master_0/m00_axi_aclk] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net read_base_addr_0_1 [get_bd_ports read_base_addr] [get_bd_pins my_axi_master_0/read_base_addr]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins my_axi_master_0/m00_axi_aresetn] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net start_read_txn_0_1 [get_bd_ports start_read_txn] [get_bd_pins my_axi_master_0/start_read_txn]
  connect_bd_net -net start_write_txn_0_1 [get_bd_ports start_write_txn] [get_bd_pins my_axi_master_0/start_write_txn]
  connect_bd_net -net write_base_addr_0_1 [get_bd_ports write_base_addr] [get_bd_pins my_axi_master_0/write_base_addr]
  connect_bd_net -net write_data_0_1 [get_bd_ports write_data] [get_bd_pins my_axi_master_0/write_data]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces my_axi_master_0/m00_axi] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.656388",
   "Default View_TopLeft":"-210,-154",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 1490 -y 80 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 1490 -y 100 -defaultsOSRD
preplace port port-id_start_write_txn -pg 1 -lvl 0 -x 0 -y 330 -defaultsOSRD
preplace port port-id_start_read_txn -pg 1 -lvl 0 -x 0 -y 350 -defaultsOSRD
preplace portBus write_base_addr -pg 1 -lvl 0 -x 0 -y 370 -defaultsOSRD
preplace portBus read_base_addr -pg 1 -lvl 0 -x 0 -y 390 -defaultsOSRD
preplace portBus write_data -pg 1 -lvl 0 -x 0 -y 410 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 4 -x 1240 -y 130 -defaultsOSRD
preplace inst my_axi_master_0 -pg 1 -lvl 2 -x 550 -y 390 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 3 -x 870 -y 120 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -x 210 -y 150 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 3 -x 870 -y 330 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 5 30 260 400 260 720 240 1040 240 1450
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 5 40 250 NJ 250 NJ 250 NJ 250 1440
preplace netloc read_base_addr_0_1 1 0 2 NJ 390 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 410 190 730
preplace netloc start_read_txn_0_1 1 0 2 NJ 350 NJ
preplace netloc start_write_txn_0_1 1 0 2 NJ 330 NJ
preplace netloc write_base_addr_0_1 1 0 2 NJ 370 NJ
preplace netloc write_data_0_1 1 0 2 NJ 410 NJ
preplace netloc axi_mem_intercon_M00_AXI 1 3 1 N 120
preplace netloc my_axi_master_0_m00_axi 1 2 1 710 60n
preplace netloc processing_system7_0_DDR 1 4 1 NJ 80
preplace netloc processing_system7_0_FIXED_IO 1 4 1 NJ 100
levelinfo -pg 1 0 210 550 870 1240 1490
pagesize -pg 1 -db -bbox -sgen -210 0 1610 510
"
}
...
# End of cr_bd_axi_verif_bd()
cr_bd_axi_verif_bd ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files axi_verif_bd.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files axi_verif_bd.bd ] 
set_property IS_ENABLED "1" [get_files axi_verif_bd.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files axi_verif_bd.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files axi_verif_bd.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files axi_verif_bd.bd ] 
set_property PFM_NAME "" [get_files axi_verif_bd.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files axi_verif_bd.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files axi_verif_bd.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files axi_verif_bd.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files axi_verif_bd.bd ] 
set_property USED_IN_SIMULATION "1" [get_files axi_verif_bd.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files axi_verif_bd.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse axi_verif_bd.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/my_axi_master_verif/my_axi_master_verif.gen/sources_1/bd/axi_verif_bd/hdl/axi_verif_bd_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse axi_verif_bd.bd] -top]
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/my_axi_master_verif.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/my_axi_master_verif.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/my_axi_master_verif.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
